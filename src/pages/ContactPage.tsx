...
const ContactPage = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: "Location",
      value: "Cupertino, CA",
      link: "https://maps.google.com/?q=Cupertino,CA"
    }
  ];
  
  const socialLinks = [
    { icon: Github, label: "GitHub", link: "https://github.com/" },
    { icon: Linkedin, label: "LinkedIn", link: "https://linkedin.com/in/" },
  ...
  return (
    <div className="container max-w-5xl mx-auto py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        ...
        <div className="md:col-span-1 space-y-8">
          <div className="bg-card rounded-lg p-6 shadow-md">
            <h2 className="text-xl font-tech text-primary mb-6">Contact Information</h2>
          ...
          {/* Social Links */}
          <div className="bg-card rounded-lg p-6 shadow-md">
            <h2 className="text-xl font-tech text-primary mb-6">Connect with Me</h2>
          ...
          {/* Availability */}
          <div className="bg-card rounded-lg p-6 shadow-md">
            <h2 className="text-xl font-tech text-primary mb-4">Availability</h2>
        ...
        <div className="md:col-span-2">
          <div className="bg-card rounded-lg p-6 shadow-md">
            <h2 className="text-xl font-tech text-primary mb-6">Send Me a Message</h2>
      ...
      <div className="mt-12 bg-card rounded-lg p-6 shadow-md">
        <h2 className="text-xl font-tech text-primary mb-6 text-center">Office Hours</h2>
