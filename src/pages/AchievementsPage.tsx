...
const achievements = [
  {
    ...
    date: "2025",
    description:
      "Ranked in the top 10% on LeetCode with a rating of 1700+, solving over 800 coding problems using Java.",
    icon: "trophy",
  },
  {
    title: "5⭐ in Java & Problem Solving",
    category: "Skill Recognition",
    date: "2024",
    description:
      "Earned 5-star badges in both Java and Problem Solving on HackerRank, showcasing strong problem-solving skills.",
    icon: "star",
  },
  {
    title: "Tech Mentor & Community Contributor",
    category: "Community",
    date: "2024 - Present",
    description:
      "Actively mentor juniors and contribute to tech communities by sharing knowledge in web development, DSA, and project building.",
    icon: "speaker",
  },
  {
    title: "Academic Excellence",
    category: "Education",
    date: "Till 5th Semester",
    description:
      "Maintained a strong academic record with a GPA of 9.03, demonstrating consistency and dedication in core Computer Science subjects.",
    icon: "trophy",
  },
];
...
//     description:
//       "A novel approach to dynamically allocating cloud resources based on predictive usage patterns and machine learning.",
//   },
//   {
...
//     description:
//       "An efficient architecture for processing large volumes of data in real-time with minimal latency and high fault tolerance.",
//   },
// ];
        ...
        <div className="space-y-6">
          {patents.map((patent, index) => (
            <div key={index} className="bg-card rounded-lg p-6 shadow-md">
              ...
              <p className="text-muted-foreground mb-4">{patent.description}</p>
